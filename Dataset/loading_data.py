...
data_path = "/lab/mksimmon/Downloads/Shixian_Transformer/Dataset/data_padded"
...
# Checking if all the data has been padded correctly:
...
#     array = np.load(f"{path_data}/{file}", allow_pickle = True)
#     for person in range(array.shape[0]):
#         if array[person].shape == 0:
#             print(f"we need to pad person {person} in file {file}.")
#         else:
#             print(f"file {file} is all padded!")
